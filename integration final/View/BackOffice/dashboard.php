...
<head>
    ...
    <title>Dashboard Admin â€” BarchaThon</title>
...
<aside class="sidebar">
    <div class="brand">
        ...
        <div>
            ...
            <small>Admin â€” <?php echo htmlspecialchars($user['nom']); ?></small>
        </div>
    </div>
    <nav class="side-nav">
    ...
    <div class="side-note">Administration BarchaThon â€” gestion des marathons, parcours et utilisateurs.</div>
</aside>
...
<?php if ($activeTab === 'home'): ?>
    ...
    (function(){
        ...
        else if (h >= 12 && h < 17) { greet = 'Bon aprÃ¨s-midi'; icon = SUN; }
...
<?php elseif ($activeTab === 'marathons'): ?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-lbl">Marathons affichÃ©s</div>
        </div>
        <div class="stat-card">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                <a class="btn btn-secondary btn-sm" href="voirdetailsparcours.php?id=<?php echo $m2['id_marathon']; ?>">Voir dÃ©tails</a>
...
<?php elseif ($activeTab === 'parcours'): ?>
    ...
    <div class="head fade-in">
        <div>
            ...
            <div class="muted">Liste complete â€” consultation et suppression uniquement.</div>
        </div>
    </div>
    ...
    <div class="panel">
        <form method="GET" id="fmP" class="filter-bar">
            ...
            <select name="difficulte" id="dP">
                ...
                <option value="facile" <?php echo $filterDiff==='facile'?'selected':''; ?>>ðŸŸ¢ Facile</option>
                <option value="moyen" <?php echo $filterDiff==='moyen'?'selected':''; ?>>ðŸŸ¡ Moyen</option>
                <option value="difficile" <?php echo $filterDiff==='difficile'?'selected':''; ?>>ðŸ”´ Difficile</option>
            </select>
        </form>
    </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo !empty($p2['heure_depart']) ? '<span style="font-weight:700;">'.htmlspecialchars(substr($p2['heure_depart'],0,5)).'</span>' : '<span style="color:#94a3b8;">â€”</span>'; ?></td>
                        ...
                        <td>
                            <div class="table-actions">
                                <a class="btn btn-secondary btn-sm" href="../FrontOffice/detailMarathon.php?id=<?php echo $p2['id_marathon']; ?>">Voir dÃ©tails</a>
...
?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-lbl">Stands affichÃ©s</div>
        </div>
        <div class="stat-card">
...
?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-lbl">Produits affichÃ©s</div>
        </div>
        <div class="stat-card">
...
<?php elseif ($activeTab === 'commandes'): ?>
    ...
    <section class="section-card fade-in">
                ...
                <div class="filter-group">
                    ...
                    <label>
                        ...
                        <select name="dirC" onchange="this.form.submit()">
                            <option value="DESC"<?php echo $dirC === 'DESC' ? ' selected' : ''; ?>>DÃ©croissant</option>
        ...
        <div id="deleteCommandesArea" style="margin-bottom:12px; display:none;">
            <button type="button" class="btn btn-danger" onclick="deleteSelectedCommandes()">Supprimer les sÃ©lectionnÃ©s</button>
    ...
    <section class="section-card fade-in">
                ...
                <div class="filter-group">
                    <label>
                        ...
                        <select name="sortL" onchange="this.form.submit()">
                            ...
                            <option value="quantite"<?php echo $sortL === 'quantite' ? ' selected' : ''; ?>>QuantitÃ©</option>
                    ...
                    <label>
                        ...
                        <select name="dirL" onchange="this.form.submit()">
                            ...
                            <option value="DESC"<?php echo $dirL === 'DESC' ? ' selected' : ''; ?>>DÃ©croissant</option>
                        </select>
                    </label>
                </div>
            </div>
        ...
        <div id="deleteLignesArea" style="margin-bottom:12px; display:none;">
            <button type="button" class="btn btn-danger" onclick="deleteSelectedLignes()">Supprimer les sÃ©lectionnÃ©s</button>
...
function updateCommandesCount() {
    ...
    if (count > 0) {
        ...
        countSpan.textContent = count + ' commande(s) sÃ©lectionnÃ©e(s)';
    } else {
...
function deleteSelectedCommandes() {
    ...
    if (confirm('ÃŠtes-vous sÃ»r de vouloir supprimer ' + checkboxes.length + ' commande(s) ?')) {
...
function updateLignesCount() {
    ...
    if (count > 0) {
        area.style.display = 'block';
        countSpan.textContent = count + ' ligne(s) sÃ©lectionnÃ©e(s)';
    } else {
        area.style.display = 'none';
    }
}
...
function deleteSelectedLignes() {
    var checkboxes = document.querySelectorAll('.selectLigne:checked');
    if (checkboxes.length === 0) {
        alert('Veuillez sÃ©lectionner au moins une ligne');
        return;
    }
    if (confirm('ÃŠtes-vous sÃ»r de vouloir supprimer ' + checkboxes.length + ' ligne(s) ?')) {
        var ids = Array.from(checkboxes).map(cb => cb.value);
...
function toggleEdit(btn, id) {
    if (isEditingStand) {
        alert("Veuillez enregistrer la ligne en cours d'Ã©dition.");
        return;
    }
