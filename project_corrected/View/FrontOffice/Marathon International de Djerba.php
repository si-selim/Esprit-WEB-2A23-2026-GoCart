...
<body>
    ...
    <div class="stand">
        ...
        <!-- CATEGORIE 1 -->
        <h2 class="category-title">Stand-Marathon International de Djerba</h2>
        <div class="grid-stands">
            <div class="card">
                <div class="card-head">
                    <h3>🏪 Stand Premium</h3>
                    <div class="stand-position"><span class="pin-icon">📍</span> Position : Cadeaux</div>
                </div>
                <div class="card-body">
                    <p class="stand-desc">Cadeaux, textile et packs officiels.</p>
                    <div class="card-buttons">
                        <a class="btn-catalogue" href="produitC4.php">🛒 Voir catalogue produits</a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const idParcours = 2; // Marathon International de Djerba
