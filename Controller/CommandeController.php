...
class CommandeController {
    ...
    public function addCommande(Commande $commande) {
        $sql = "INSERT INTO commande (idutilisateur, idstand, datecommande, statut, montanttotale, modePaiement) VALUES (:idutilisateur, :idstand, :datecommande, :statut, :montanttotal, :modePaiement)";
        $db = config::getConnexion();
        try {
