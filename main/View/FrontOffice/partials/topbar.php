...
<div class="fo-topbar">
    <div class="fo-topbar-shell">
        ...
        <nav class="fo-nav">
            <a class="fo-link <?php echo $currentPage==='accueil'?'active':''; ?>" href="accueil.php">Accueil</a>
            <a class="fo-link <?php echo $currentPage==='catalogue'?'active':''; ?>" href="listMarathons.php">Catalogue</a>
            ...
            <?php elseif ($role === 'participant'): ?>
                <a class="fo-link <?php echo $currentPage==='profile'?'active':''; ?>" href="profile.php">Mon profil</a>
                <span class="fo-user"><?php echo htmlspecialchars($user['nom']); ?> <span class="fo-role-badge">participant</span></span>
                <a class="fo-link" href="logout.php">Se déconnecter</a>
            ...
            <?php elseif ($role === 'admin'): ?>
                <a class="fo-link" href="../BackOffice/dashboard.php">Dashboard</a>
                <a class="fo-link <?php echo $currentPage==='profile'?'active':''; ?>" href="profile.php">Mon profil</a>
