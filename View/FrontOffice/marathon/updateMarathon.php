...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nom !== '' && $region !== '' && $date !== '') {
        ...
        $m = new Marathon($id, $nom, $image, $org, $region, $date, $places, $prix);
        ...
        <form method="POST" enctype="multipart/form-data" novalidate>
            <div class="grid">
                ...
                <div class="field">
                    ...
                    <input type="text" class="auto-field" value="<?php echo htmlspecialchars($data['organisateur_marathon']); ?>" readonly>
                    <span class="auto-note">✅ Organisateur enregistré</span>
                </div>
                <!-- 7. Image -->
                <div class="field full">
                    <label for="image_marathon">Changer la Photo</label>
