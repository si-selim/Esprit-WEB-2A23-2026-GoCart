...
<head>
    ...
    <title>Choisir un sponsor</title>
    <style>
        :root {
            --ink:#102a43;
            --teal:#0f766e;
        ...
        * { box-sizing:border-box; }
        ...
        .item-select { display:inline-flex; align-items:center; gap:8px; padding:10px 14px; border-radius:14px; border:1px solid rgba(16,42,67,.12); background:#f8fafb; color:var(--ink); text-decoration:none; }
        ...
        <div class="card">
                ...
                <table>
                    ...
                    <tbody>
                        <?php 
                            ...
                            $extraParams = $idMarathon ? "&idMarathon=$idMarathon" : ''; 
                            $formParamsArray = [];
                            ...
                            $controller->afficherSponsor(false, false, false, true, $extraParams, $formParams); 
                        ?>
                    </tbody>
                </table>
            </div>
            <div class="actions">
                <a class="btn btn-secondary" href="addSponsoring.php<?php 
                    $params = [];
                    if ($idMarathon) $params[] = 'idMarathon=' . $idMarathon;
